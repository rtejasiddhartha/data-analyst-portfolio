    ...
    <>
      ...
      <section id="hero" className={`relative min-h-screen flex items-center justify-center px-8 py-12 overflow-hidden ${d ? 'bg-[#0a0a12]' : 'bg-gray-50'}`}>
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <div className="anim-hero"><span className={`inline-block px-4 py-1.5 rounded-full text-[10px] font-semibold tracking-widest uppercase mb-5 border ${d ? 'bg-indigo-500/10 text-indigo-300 border-indigo-500/20' : 'bg-indigo-50 text-indigo-600 border-indigo-100'}`}>Data Analyst</span></div>
          ...
          <div className={`rounded-2xl p-8 border shadow-xl ${d ? 'bg-[#13131f] border-white/[0.06]' : 'bg-white border-gray-200'}`}>
            <div className="grid grid-cols-3 gap-8 items-start">
              <div className="col-span-2">
                ...
                <p className={`text-sm font-medium mb-3 ${d ? 'text-indigo-300' : 'text-indigo-600'}`}>Data Analyst | SQL • Python • Power BI | End-to-End Analytics</p>
